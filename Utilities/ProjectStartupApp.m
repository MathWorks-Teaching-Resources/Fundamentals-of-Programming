classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "Fundamentals-of-Programming";
    end
...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Text = 'Welcome to Fundamentals of Programming';
            ...
            app.Image.ImageSource = 'Computer-Thoughtbubble.png';
            ...
            app.ReviewTitle.Text = 'Welcome to Fundamentals of Programming';
